...
example_orig_onesided_twosided <- read.table("Data example 2/Original study/Data_orig_onesided_twosided.txt",header=T)
example_repl_onesided_twosided <- read.table("Data example 2/Replication study/Data_repl_onesided_twosided.txt",header=T)
